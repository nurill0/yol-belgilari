...
class AdditionalInformationController: UIViewController {

    let model = AdditionalData()
    lazy var collectioView: UICollectionView = {
       let layout = UICollectionViewFlowLayout()
        ...
        collectionView.register(AdditionalCell.self, forCellWithReuseIdentifier: AdditionalCell.identifier)
