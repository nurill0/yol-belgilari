//
//  InformationIndexController.swift
//  yol belgilari
//
...
class InformationIndexController: UIViewController {
    let model = InformationIndexData()
    lazy var collectioView: UICollectionView = {
       let layout = UICollectionViewFlowLayout()
        ...
        collectionView.register(InformationIndexCell.self, forCellWithReuseIdentifier: InformationIndexCell.identifier)
