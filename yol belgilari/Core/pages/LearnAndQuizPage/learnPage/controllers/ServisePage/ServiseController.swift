...
class ServiseController: UIViewController {
    let model = ServiseData()
    lazy var collectioView: UICollectionView = {
       let layout = UICollectionViewFlowLayout()
        ...
        collectionView.register(ServiseCell.self, forCellWithReuseIdentifier: ServiseCell.identifier)
